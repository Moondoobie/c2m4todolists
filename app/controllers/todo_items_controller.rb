class TodoItemsController < ApplicationController
  ...
  # index not used. Items only called in context of a list.
  # GET /todo_lists/:todo_list_id/todo_items
  # GET /todo_lists/:todo_list_id/todo_items.json
  # def index
  ...
  def create
    ...
    respond_to do |format|
      if @todo_item.save
        format.html { redirect_to todo_list_todo_list_id_index_url, notice: 'Todo item was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @todo_item.update(todo_item_params)
        format.html { redirect_to redirect_to todo_list_todo_list_id_index_url, notice: 'Todo item was successfully updated.' }
  ...
  def destroy
    @todo_item.destroy
    respond_to do |format|
      format.html { redirect_to todo_list_todo_list_id_index_url, notice: 'Todo item was successfully destroyed.' }
